 ...
 * {
 *
 *     public static readonly void main (String args[])
 ...
 */
    public abstract class XmlPullParser
    {
         ...
         * @see #setFeature
         */
        public static readonly string FEATURE_PROCESS_NAMESPACES =
         ...
         * @see #setFeature
         */
        public static readonly string FEATURE_REPORT_NAMESPACE_ATTRIBUTES =
         ...
         * @see #setFeature
         */
        public static readonly string FEATURE_PROCESS_DOCDECL =
         ...
         * @see #setFeature
         */
        public static readonly string FEATURE_VALIDATION =
         ...
         */
        public abstract void setInput(StreamReader input);
