...
{
    public class TypeHeader : ChunkHeader
    {
        public static readonly long NO_ENTRY = 0xFFFFFFFFL;
        ...
        public TypeHeader(int chunkType, int headerSize, long chunkSize) : base(chunkType, headerSize, chunkSize)
        {
            //base(chunkType, headerSize, chunkSize);
        }
